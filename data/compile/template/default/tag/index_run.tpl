...
<style type="text/css">
    			...
    			$__design_data = $__design->getDataByModules(array(6,5,));
...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb">
			<a href="<?php echo Wind::getComponent('response')->getData('G', 'url', 'base'),'/',''; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a>
		</div>
		<div class="tag_page_run cc">
			...
			<!--新话题列表-->
			<div class="mb20">
				<div role="structure_jyjxjy" data-lcm="tab" class="box_wrap design_layout_style J_mod_layout J_tab_wrap" id="jyjxjy">			<div role="titlebar" class="design_layout_hd design_layout_tab cc J_layout_hd" style=""><ul class="J_tabs_nav" role="tablist"><li role="tab" class="current"><a data-id="tab_1" href="" style="float:left;margin-left:0px;">栏目1</a></li><li role="tab" class=""><a data-id="tab_2" href="">栏目2</a></li></ul></div>			<div class="J_tabs_ct"><div class="design_layout_ct J_tabct_tab_1 J_layout_item" tabid="tab_1" role="tabpanel" aria-hidden="false" style="display: block;"><div id="J_mod_6" style="" data-id="6" data-model="tag" class="mod_box J_mod_box"><div class="tmode_imglist">
  <?php if(is_array($__design_data['J_mod_6'])){
						$__data=$__design_data['J_mod_6'];
					}else{
						$display=Wekit::load('design.srv.display.PwDesignDisplay');
						$__data=$display->getModuleData(6);
					};foreach($__data AS $__k=>$__v){?>
  <dl class="cc">
    <dt><a href="<?php echo WindSecurity::escapeHTML($__v['url']);?>"><img src="<?php echo WindSecurity::escapeHTML($__v['logo']);?>" alt="<?php echo WindSecurity::escapeHTML($__v['title']);?>" width="80" height="60"></a></dt>
    <dd><a href="<?php echo WindSecurity::escapeHTML($__v['url']);?>"><?php if($__v['__style']){?><span style="<?php echo WindSecurity::escapeHTML($__v['__style']);?>"><?php echo WindSecurity::escapeHTML(Pw::substrs($__v['title'],10));?></span><?php }else{
 echo WindSecurity::escapeHTML(Pw::substrs($__v['title'],10));
 }?></a><?php echo WindSecurity::escapeHTML(Pw::substrs($__v['excerpt'],20));?></dd>
  </dl>
  <?php }?>
</div></div></div>			<div class="design_layout_ct J_tabct_tab_2 J_layout_item" tabid="tab_2" style="display: none;" role="tabpanel" aria-hidden="true"></div></div></div><div role="structure_kyjffk" data-lcm="100" class="box_wrap design_layout_style J_mod_layout" id="kyjffk">			<h2 role="titlebar" class="design_layout_hd cc J_layout_hd" style=""><span>100%</span></h2>			<div class="design_layout_ct J_layout_item"><div id="J_mod_5" style="" data-id="5" data-model="tag" class="mod_box J_mod_box"><div class="tmode_list">
<ul>
<?php if(is_array($__design_data['J_mod_5'])){
						$__data=$__design_data['J_mod_5'];
					}else{
						$display=Wekit::load('design.srv.display.PwDesignDisplay');
						$__data=$display->getModuleData(5);
					};foreach($__data AS $__k=>$__v){?>
	<li><a href="<?php echo WindSecurity::escapeHTML($__v['url']);?>" target="_blank" target="_blank"><?php if($__v['__style']){?><span style="<?php echo WindSecurity::escapeHTML($__v['__style']);?>"><?php echo WindSecurity::escapeHTML($__v['title']);?></span><?php }else{
